        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            Ethereum: $${ethereumPrice}`;
                ...
                if (user) {
                    ...
                    else if ((textArray.length === 2 && !(user === null || user === void 0 ? void 0 : user.pin)) || (textArray.length === 3 && user.pin && (user.pin === textArray[1]))) {
                        // Ask for confirmation of the new PIN (after asking for the new PIN)
                        response = `CON Confirm new PIN:`;
                    }
                    else if ((textArray.length === 3 && textArray[1] === textArray[2] && !(user === null || user === void 0 ? void 0 : user.pin)) || (textArray.length === 4 && user.pin && (user.pin === textArray[1]) && (textArray[2] === textArray[3]))) {
